...
/opt/monodevelop/bin/mono "${solver}" -x -i=simulation -f="${assetdir}/linear2dloop.world" -c="${assetdir}/linear2loop.in" -a=odometry -g="${cfgfile}" -r="${odofile}"
